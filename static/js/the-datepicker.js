...
(function (TheDatepicker) {
    ...
    var Month;
    (function (Month) {
        Month[Month["فروردین"] = 0] = "فروردین";
        Month[Month["اردیبهشت"] = 1] = "اردیبهشت";
        Month[Month["خرداد"] = 2] = "خرداد";
        Month[Month["تیر"] = 3] = "تیر";
        Month[Month["مرداد"] = 4] = "مرداد";
        Month[Month["شهریور"] = 5] = "شهریور";
        Month[Month["مهر"] = 6] = "مهر";
        Month[Month["آبان"] = 7] = "آبان";
        Month[Month["آذر"] = 8] = "آذر";
        Month[Month["دی"] = 9] = "دی";
        Month[Month["بهمن"] = 10] = "بهمن";
        Month[Month["اسفند"] = 11] = "اسفند";
